-- EduCloud Content 数据库：技术表（V000）
-- 依据：docs/superpowers/specs/2026-08-18-educloud-data-design.md 第 14 节与 2026-08-24-educloud-content-design.md
...
INSERT INTO outbox_sequence (source_name, `last_value`) VALUES ('educloud-content', 0);
...
GRANT SELECT, INSERT, UPDATE, DELETE ON educloud_content.outbox_event TO 'content_app'@'%';
GRANT SELECT, UPDATE ON educloud_content.outbox_sequence TO 'content_app'@'%';
GRANT SELECT, INSERT, UPDATE, DELETE ON educloud_content.inbox_event TO 'content_app'@'%';
GRANT SELECT, INSERT ON educloud_content.audit_event TO 'content_app'@'%';
GRANT SELECT, INSERT, UPDATE, DELETE ON educloud_content.idempotency_record TO 'content_app'@'%';
