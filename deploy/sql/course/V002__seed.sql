...
--      版本 120-127 / 归属 130-137 / 提交 140 / 选课 150-151 / 评价 160-161），
--      避免与运行时 ID 冲突；
...
VALUES
  (9000000000000000110, 9000000000000000001, 'PUBLISHED', 9000000000000000120, NULL,
   '2026-08-10 10:00:00.000', 5.00, 1, 1, 0, 9000000000000000001, '2026-08-09 09:00:00.000', 9000000000000000001, '2026-08-16 10:00:00.000'),
...
-- 选课：fe_demo_10 免费选 2 门已发布课程（我的课程演示）。
...
-- 评价：2 条，对应已选课程（fe_demo_10）；course.rating_avg/rating_count 与之吻合。
