...
if port_free 8091; then
  ...
  EDUCLOUD_ORDER_NACOS_USERNAME="${EDUCLOUD_ORDER_NACOS_USERNAME:-educloud_order}" EDUCLOUD_ORDER_NACOS_PASSWORD="${NACOS_ORDER_PASSWORD:-${NACOS_COURSE_PASSWORD:-nacos}}" \
