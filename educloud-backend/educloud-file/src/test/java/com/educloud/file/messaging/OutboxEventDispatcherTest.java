 ...
 * {@code aggregateType.aggregateId}（FileObject.1001）。
 */
class OutboxEventDispatcherTest {
    ...
    void relayPublishesClaimedEventAfterSuccessfulDispatch() {
        ...
        // M04 坑 3：routing key 为点分隔 FileObject.1001（Topic 交换机通配绑定）。
        verify(rabbitTemplate).convertAndSend(eq("FileObject.1001"), any(Object.class));
