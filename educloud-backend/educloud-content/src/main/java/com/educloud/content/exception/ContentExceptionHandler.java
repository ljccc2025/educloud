...
public final class ContentExceptionHandler {
    ...
    public ContentExceptionHandler(ApiResponseFactory responses) {
    ...
    public ResponseEntity<ApiResponse<Void>> handleAccessDenied(AccessDeniedException exception) {
        return respond(
                ContentErrorCode.COURSEWARE_ACCESS_DENIED,
                ContentErrorCode.COURSEWARE_ACCESS_DENIED.defaultMessage(),
                null);
    }
    ...
    public ResponseEntity<ApiResponse<ValidationErrorDetails>> handleBodyValidation(
        ...
        List<FieldViolation> violations = exception.getBindingResult().getFieldErrors().stream()
                .map(ContentExceptionHandler::toViolation)
