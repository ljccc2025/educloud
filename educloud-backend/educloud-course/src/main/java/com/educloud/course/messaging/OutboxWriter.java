 ...
 * 复用 M03/M04 的 OutboxWriter 模式（educloud-file/educloud-user 同构）。M05 任务 9
 * 直接落 outbox_event 行；事件信封字段（EventEnvelope）由任务 15 的 dispatcher 组装。
 */
@Component
public class OutboxWriter {

    private static final String SOURCE_NAME = "educloud-course";
